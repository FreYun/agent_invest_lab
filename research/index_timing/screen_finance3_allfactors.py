"""对 金融 3 指数跑 local_sweep 全 44 因子 IS/OOS + validation，系统找绿灯。
保险 399809 / 中证银行 399986 / 证券 399975（复用 consumer4 模板）。
数据从 simworld 18078 拉指数全周期（probe_finance3.py 已确认仅 close，无 high/low）。"""
...
_,sid=call("initialize",{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"fin3f","version":"1"}})
RES4=[("保险主题","399809.SZ"),("中证银行","399986.SZ"),
      ("证券公司","399975.SZ")]

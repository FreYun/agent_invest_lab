"""对 自由现金流指数跑 local_sweep 全 44 因子 IS/OOS + validation，系统找绿灯。
自由现金流 980092（复用 finance3 模板）。
数据从 simworld 18078 拉指数全周期（probe_fcf.py 已确认仅 close，无 high/low）。"""
...
_,sid=call("initialize",{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"fcf1f","version":"1"}})
RES4=[("自由现金流","980092.SZ")]

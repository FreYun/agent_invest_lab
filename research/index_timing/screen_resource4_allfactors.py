"""对 4 个资源/周期子板块跑 local_sweep 全 44 因子 IS/OOS + validation，系统找绿灯。
拆分 nonferrous(000819 广义有色) → 工业有色/稀土/CS稀金属 + 独立的细分化工。
...
_,sid=call("initialize",{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"res4f","version":"1"}})
RES4=[("工业有色","H11059.CSI"),("稀土产业","930598.CSI"),
      ("CS稀金属","930632.CSI"),("细分化工","000813.CSI")]
syms=[c for _,c in RES4]
res,_=call("tools/call",{"name":"market_index_quote","arguments":{"market":"cn","symbols":syms,"start_date":"2014-01-01","end_date":"2026-06-05","simulated_datetime":"2026-06-05 15:00:00","simulated_today":"2026-06-05"}},sid)

...
# TOOLS.md - bot101t_k2（多指数权益基金配置 bot · 测试分身）工具配置
...
- **account_id**: `bot101t_k2`
  - ⚠️ 所有 fund-portfolio-mcp / strategy-mcp 工具调用的 `bot_id` 一律传 `bot101t_k2`，**绝不能传 bot101**（否则会写到生产账户）。
